...
If the terminal cannot display the Unicode QR, the script renders ASCII-only
versions locally for both light and dark terminal backgrounds. It never prints
the login token or asks you to send it to an external QR service.
```
